...
The sensor technology used in STS is required to provide high track reconstruction
 efficiency as well as low material mass. Double-sided, 300 $\mu m$ thick
 microstrip sensor with a second metalization layer were chosen due to the fact that
 they yield the same space-point determination resolution using only half the amount
 of silicon material compared to single-sided sensors. The geometry design of STS
...
Due to a large-scale sensor production, the effective QA of sensors can be
 achieved by a collective effort among the Quality Test Centers built in GSI
 cleanroom. Fig. \ref{ywu:fig:qa} indicates the variety of quality assurance 
 tests and the corresponding QTC in charge. The overall QA program can be represented
 as a combination of tests performed on sensor and strip level.
...
\begin{figure}[htb]
	...
	\caption{General view of the Quality Test Center (QTC) in GSI cleanroom.}
	\label{ywu:fig:qtc}
\end{figure}
...
\begin{figure}[htb]
	...
	\caption{Quality assurance data scheme.}
	\label{ywu:fig:stsdb}
\end{figure}
