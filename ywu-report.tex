...
For strip diagnostic tests, the information on identified defect will be stored, which
 was shown in Tab. \ref{ywu:table:strip}. All parameter classed are compatible with the
 FairDB framework scheme and could be used for the data analysis \cite{ywu:fr}.
