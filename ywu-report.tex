...
An implementation of the STS QA database and its web interface (Fig. \ref{ywu:fig:dbweb})
 based on FairDB is available now. It stores information on sensor parameters and quality
 assurance results as well ass tracking information for logistic purpose.
...
%%%%%%%
% Picture - Data query with FairDB web interface
%%%%%%%
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.45\textwidth]{fig/ywu-dbweb}
	\caption{Snapshot of STS~QA web interface.}
	\label{ywu:fig:dbweb}
\end{figure}
