...
The Silicon Tracking System (STS) is the central detector fo the CBM
 experiment. Its task is the standalone trajectory reconstruction
...
The sensor technology used in STS is required to provide high track reconstruction
 efficiency as well as low material mass. As a result, the double-sided, 300 $\mu m$ thick
...
The STS will consist of eight planar tracking stations with about 1200 sensors.
 And once a module has been built it can not be modified or repaired.
 This is why QA for every component is very important before module assembly. 
